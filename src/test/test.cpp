...
int main ( )
{
    ...
    {
        cout<< "\n++++++ TESTPROB " <<endl;
        mpsReader mpsTESTPROB("test_data/TESTPROB.QPS");
    ...
    try {
        cout<< "\n++++++ TESTPROB2" <<endl;
        mpsReader mpsTESTPROB2("test_data/TESTPROB2.QPS");
    ...
    {
        cout<< "\n+++++ QAFIRO " <<endl;
        mpsReader mpsQAFIRO("test_data/QAFIRO.QPS");
    ...
    {
        cout<< "\n+++++ SIMPLE" <<endl;
        mpsReader mpsSIMPLE("test_data/SIMPLE.QPS");
